<?php
namespace exface\SqlDataConnector\ModelLoaders;
...
Relation::RELATION_TYPE_REVERSE); // relation type
                        ...
                        $rel = new Relation($exface, $attr->get_id(), $attr->get_alias(), $attr->get_name(), $object->get_id(), $attr->get_alias(), $row['related_object_oid'], $row['related_object_special_key_attribute_oid'], Relation::RELATION_TYPE_FORWARD);
                    }
